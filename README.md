...
```json
"devDependencies": { "soksak-kit-browser-common": "github:soksak-ai/soksak-kit-browser-common" }
```

```ts
import { normalizeUrl, renderNavState, createLifecycle, forwardInput } from "soksak-kit-browser-common";
```
